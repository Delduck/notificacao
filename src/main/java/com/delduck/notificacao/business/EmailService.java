package com.delduck.notificacao.business;

import com.delduck.notificacao.business.dto.TarefasDTO;
import com.delduck.notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO tarefasDTO) {
        ...
        try{
            ...
            throw new EmailException("Erro ao envia o email ", e.getCause());
        }
